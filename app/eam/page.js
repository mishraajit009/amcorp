                    ...
                    <div className="auto-container">
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                            ...
                            <div className="content-box mr_110">
                                ...
                                <p>
                                A&M excels in EAM recruitment, connecting you with top professionals skilled in portfolio expansion and client relations, ensuring exceptional service delivery.
                                </p>
                                </div>
                                <div className="sec-title mb_20">
                                ...
                                <div className="text-box mb_40">
                                <p>
                                Advance your EAM career with A&M's industry connections, accessing roles in firms that value bespoke solutions and strong client relationships.
                                </p>
                                </div>
